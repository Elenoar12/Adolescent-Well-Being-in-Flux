                        ...
                        fluidRow(
                          column(width = 12, style = "text-align: center;",
                                 ...
                                 tags$a(href = "https://www.uzh.ch/en", target = "_blank",
                                        tags$img(src = "logo_UZH.png", height = "40px", width = "120px",
                                            style = "margin: 10px; cursor: pointer; transition: opacity 0.3s;",
                                            onmouseover = "this.style.opacity=0.7",
                                            onmouseout = "this.style.opacity=1")),
                                 tags$a(href = "https://www.pukzh.ch", target = "_blank",
                                        tags$img(src = "logo_PUK.png", height = "40px", width = "120px",
                                            style = "margin: 10px; cursor: pointer; transition: opacity 0.3s;",
                                            onmouseover = "this.style.opacity=0.7",
                                            onmouseout = "this.style.opacity=1")),
                                 tags$a(href = "https://www.jacobscenter.uzh.ch/en", target = "_blank",
                                        tags$img(src = "logo_JC.png", height = "40px", width = "120px",
                                            style = "margin: 10px; cursor: pointer; transition: opacity 0.3s;",
                                            onmouseover = "this.style.opacity=0.7",
                                            onmouseout = "this.style.opacity=1")),
                                 tags$a(href = "https://ki.se/en", target = "_blank",
                                        tags$img(src = "logo_KI.png", height = "60px", width = "120px",
                                                 style = "margin: 10px; cursor: pointer; transition: opacity 0.3s;",
                                                 onmouseover = "this.style.opacity=0.7",
                                                 onmouseout = "this.style.opacity=1")),
                                 tags$a(href = "https://umcgresearch.org/", target = "_blank",
                                        tags$img(src = "logo_UMCG.png", height = "30px", width = "120px",
                                                 style = "margin: 10px; cursor: pointer; transition: opacity 0.3s;",
                                                 onmouseover = "this.style.opacity=0.7",
                                                 onmouseout = "this.style.opacity=1"))
                          )
